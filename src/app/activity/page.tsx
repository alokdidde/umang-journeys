...
export default function ActivityPage() {
  ...
  return <main className="page hub-page activity-page">
    <header className="hub-page-header content-layer"><div><p className="eyebrow"><Activity />Recent activity</p><h1>What changed</h1><p>A simple history of your journeys and documents.</p></div></header>
